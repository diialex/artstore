...
class ProductsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $product->sizes()->createMany([['size' => 'M', 'stock' => 1]]);
        ...
        $product->categories()->attach(1);
        $product->sizes()->createMany([['size' => 'Único', 'stock' => 1]]);
        ...
        $product->categories()->attach(1);
        $product->sizes()->createMany([['size' => 'S', 'stock' => 1]]);

        // 7. Crochet Estrella Negro Azul
        $product = Product::create([
            'title' => [
        ...
        $product->categories()->attach(1);
        $product->sizes()->createMany([['size' => 'Único', 'stock' => 2]]);

        // 12. Flor Crochet Bolsito
        $product = Product::create([
            'title' => [
