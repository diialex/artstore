...
<div class="flex flex-col items-center justify-center min-h-[60vh] px-4 py-12 w-full">
    ...
    <div class="max-w-lg w-full bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8 sm:p-12 text-center transform transition-all hover:scale-[1.01]">
        
        <div class="w-28 h-28 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-8 shadow-inner border-4 border-white">
