    ...
    <header>
        <nav class="container-fluid sticky-top bg-primary px-3 py-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center position-relative">
                <div class="d-flex justify-content-start gap-2 gap-md-3 align-items-center cursor-pointer z-3">
                    <i id="burger-menu" class="bi bi-list fs-2 text-white cursor-pointer mb-0" data-bs-toggle="offcanvas"
                        data-bs-target="#menuLateral"></i>
                    <a href="{{ route('home') }}" class="text-dark text-decoration-none d-flex align-items-center">
                        <i class="bi bi-shop fs-2 text-white cursor-pointer mb-0"></i>
                    </a>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 gap-md-3 align-items-center z-3">
                    <div class="dropdown">
