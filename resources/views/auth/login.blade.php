...
<div class="flex justify-center items-center w-full py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden transition-all">
        ...
        <div class="px-8 pt-10 pb-6 text-center border-b border-gray-50">
            ...
            <h2 class="text-2xl font-black text-dark tracking-tight">Iniciar Sesión</h2>
        </div>
        ...
        <div class="px-8 py-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-5">
                ...
                <div>
                    <label for="userCredential" class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Email o Usuario</label>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                <p class="text-xs font-medium text-gray-500 mb-4">¿No tienes cuenta?</p>
